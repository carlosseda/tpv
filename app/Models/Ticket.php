...
class Ticket extends Connection {
    ...
    public function show($table_id) {
        ...
        $query =  "SELECT productos.nombre AS nombre, precios.precio_base AS precio_base, productos.imagen_url AS imagen_url, productos_categorias.nombre AS categoria FROM tickets 
